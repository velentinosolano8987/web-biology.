...
public final class jmod extends ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
            ...
            { "main.opt.compress", "Compression to use when creating the JMOD archive. Accepted values are: zip-[0-9], where zip-0 provides no compression, and zip-9 provides the best compression. Default is zip-6." },
